"""Copilot module — conversational AI agent over DentApex (issue #81).
...
class CopilotModule(BaseModule):
    manifest = {
        "name": "copilot",
        "version": "0.1.0",
        "summary": "Conversational AI agent over DentApex, scoped to the caller's permissions.",
        "author": "DentApex Team",
        "license": "BSL-1.1",
        "category": "official",
        "depends": [],
        "installable": True,
