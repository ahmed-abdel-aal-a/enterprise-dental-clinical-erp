...
class InvoiceSeriesService:
    ...
    async def list_series(
        ...
        if branch_id is not None:
            query = query.where(or_(InvoiceSeries.branch_id == branch_id, InvoiceSeries.branch_id.is_(None)))
    ...
    async def create_series(
        ...
        if data.get("is_default"):
            ...
            if data.get("branch_id"):
                filter_conditions.append(InvoiceSeries.branch_id == data["branch_id"])
            await db.execute(
                select(InvoiceSeries)
    ...
    async def update_series(
        ...
        if "branch_id" in data:
            series.branch_id = data["branch_id"]
...
class InvoiceService:
    ...
    async def list_invoices(
        ...
        *,
        ...
        if branch_id:
            conditions.append(Invoice.branch_id == branch_id)
    ...
    async def create_invoice(
        ...
        if not branch_id:
            ...
            branch_id = res.scalar_one_or_none()
    ...
    async def create_from_budget(
        ...
        Args:
            ...
            branch_id: Optional branch ID override
        ...
        target_branch_id = branch_id or getattr(budget, "branch_id", None)
