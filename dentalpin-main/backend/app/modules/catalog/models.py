...
class TreatmentCatalogItem(Base, TimestampMixin):
    ...
    is_default_for_type: Mapped[bool] = mapped_column(Boolean, default=False)  # Default selection for clinical_type
    ...
    __table_args__ = (
        ...
        Index("idx_catalog_items_default_type", "clinic_id", "is_default_for_type"),
    )
