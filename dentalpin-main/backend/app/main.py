...
app = FastAPI(
    title="DentApex API",
    description="Smart Dental Clinic Management System (DentApex Arabic Edition)",
    version="2.0.0",
    lifespan=lifespan,
...
# Mount multi-branch management router
from app.core.branches.router import router as branches_router  # noqa: E402
