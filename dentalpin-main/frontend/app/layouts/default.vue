...
<template>
  <div class="min-h-screen flex bg-canvas">
    ...
    <aside
      class="hidden md:flex fixed inset-y-0 z-50 flex-col bg-surface-muted transition-[width] duration-150 ease-out border-subtle"
      :class="[
          ...
          <div class="flex items-center justify-between h-14 px-4">
            ...
            >
              <img
                ...
                class="shrink-0"
              >
              <span class="text-h2 text-default truncate">DentApex</span>
            </NuxtLink>
            <UButton
              variant="ghost"
              color="neutral"
    ...
    <div
      ...
      :class="[
        isSidebarCollapsed
          ? (isRtl ? 'md:mr-16 md:ml-0' : 'md:ml-16 md:mr-0')
      ...
      <header class="sticky top-0 z-40 flex items-center h-14 px-3 sm:px-4 bg-surface border-b border-subtle">
        ...
        <UButton
          ...
          :icon="isSidebarCollapsed
            ? (isRtl ? 'i-lucide-panel-right-open' : 'i-lucide-panel-left-open')
            : (isRtl ? 'i-lucide-panel-right-close' : 'i-lucide-panel-left-close')"
        ...
        <ClientOnly>
          <div
            ...
            :class="isRtl ? 'mr-3 sm:mr-4' : 'ml-3 sm:ml-4'"
          >
            <UIcon
            ...
            <BranchSwitcher
              class="shrink-0"
              :class="isRtl ? 'mr-1 sm:mr-2' : 'ml-1 sm:ml-2'"
            />
          </div>
        </ClientOnly>
